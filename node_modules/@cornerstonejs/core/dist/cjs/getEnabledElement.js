...
exports.getEnabledElements = exports.getEnabledElementByViewportId = exports.getEnabledElementByIds = void 0;
const getRenderingEngine_1 = __importStar(require("./RenderingEngine/getRenderingEngine"));
...
exports.default = getEnabledElement;
function getEnabledElementByIds(viewportId, renderingEngineId) {
    if (!renderingEngineId || !viewportId) {
        return;
    }
    const renderingEngine = (0, getRenderingEngine_1.default)(renderingEngineId);
...
exports.getEnabledElementByIds = getEnabledElementByIds;
function getEnabledElementByViewportId(viewportId) {
    const renderingEngines = (0, getRenderingEngine_1.getRenderingEngines)();
...
exports.getEnabledElementByViewportId = getEnabledElementByViewportId;
