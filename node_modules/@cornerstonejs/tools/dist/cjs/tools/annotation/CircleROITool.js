    ...
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this.addNewAnnotation = (evt) => {
            ...
            const annotation = {
                highlighted: true,
                invalidated: true,
                metadata: Object.assign({ toolName: this.getToolName(), viewPlaneNormal: [...viewPlaneNormal], viewUp: [...viewUp], FrameOfReferenceUID,
                    referencedImageId }, viewport.getViewReference({ points: [worldPos] })),
                data: {
                    label: '',
                    handles: {
                        textBox: {
