...
const { ProgressiveIterator, imageRetrieveMetadataProvider, hasFloatScalingParameters, } = core_1.utilities;
...
class BaseStreamingImageVolume extends core_1.ImageVolume {
    ...
    successCallback(imageId, image) {
        ...
        if (isFromImageCache && options.targetBuffer) {
            this.imageCacheOffsetMap.set(imageId, {
                imageIdIndex,
                frameIndex,
                offset: ((_a = options.targetBuffer) === null || _a === void 0 ? void 0 : _a.offset) || 0,
                length: (_b = options.targetBuffer) === null || _b === void 0 ? void 0 : _b.length,
            });
        }
    ...
    getLoaderImageOptions(imageId) {
        ...
        const allowFloatRendering = (0, core_1.canRenderFloatTextures)();
