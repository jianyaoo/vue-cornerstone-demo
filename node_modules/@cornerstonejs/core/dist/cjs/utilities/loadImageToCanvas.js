...
function loadImageToCanvas(options) {
    const { canvas, imageId, requestType = enums_1.RequestType.Thumbnail, priority = -5, renderingEngineId = '_thumbnails', useCPURendering = false, thumbnail = false, imageAspect = false, physicalPixels = false, viewportOptions, } = options;
