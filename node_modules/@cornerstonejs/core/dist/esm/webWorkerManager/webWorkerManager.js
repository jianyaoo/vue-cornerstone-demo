...
class CentralizedWorkerManager {
    ...
    registerWorker(workerName, workerFn, options = {}) {
        const { maxWorkerInstances = 1, overwrite = false, autoTerminateOnIdle = false, } = options;
        ...
        if ((autoTerminateOnIdle && !workerProperties.idleCheckIntervalId) ||
            overwrite) {
    ...
    executeTask(workerName, methodName, args = {}, { requestType = RequestType.Compute, priority = 0, options = {} } = {}) {
