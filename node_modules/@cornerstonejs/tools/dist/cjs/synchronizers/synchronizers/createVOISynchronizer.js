...
function createVOISynchronizer(synchronizerName, options = { syncInvertState: true }) {
    const VOISynchronizer = (0, SynchronizerManager_1.createSynchronizer)(synchronizerName, core_1.Enums.Events.VOI_MODIFIED, voiSyncCallback_1.default, Object.assign({ auxiliaryEventNames: [core_1.Enums.Events.COLORMAP_MODIFIED] }, options));
