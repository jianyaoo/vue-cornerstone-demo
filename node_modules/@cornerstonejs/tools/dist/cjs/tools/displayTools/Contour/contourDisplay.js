...
function render(viewport, representationConfig, toolGroupConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let contourData = segmentation.representationData[SegmentationRepresentations_1.default.Contour];
        if (!contourData &&
            segmentation_1.polySeg.canComputeRequestedRepresentation(representationConfig.segmentationRepresentationUID) &&
            !polySegConversionInProgress) {
            polySegConversionInProgress = true;
            contourData = yield segmentation_1.polySeg.computeAndAddContourRepresentation(segmentationId, {
