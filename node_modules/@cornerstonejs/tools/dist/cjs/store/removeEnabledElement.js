...
const imageChangeEventListener_1 = __importDefault(require("../eventListeners/segmentation/imageChangeEventListener"));
...
function removeEnabledElement(elementDisabledEvt) {
    ...
    imageChangeEventListener_1.default.disable(element);
