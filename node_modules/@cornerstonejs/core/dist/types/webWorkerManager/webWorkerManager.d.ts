...
declare class CentralizedWorkerManager {
    ...
    checkIntervalForIdleWorkers: number;
    setCheckIntervalForIdleWorkers(value: any): void;
    registerWorker(workerName: any, workerFn: any, options?: {}): void;
    getNextWorkerAPI(workerName: any): {
        api: any;
        index: number;
    };
    executeTask(workerName: any, methodName: any, args?: {}, { requestType, priority, options }?: {
