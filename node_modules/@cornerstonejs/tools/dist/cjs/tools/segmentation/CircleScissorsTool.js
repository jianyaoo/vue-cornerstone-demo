    ...
    constructor(toolProps = {}, defaultToolProps = {
        ...
        configuration: {
            strategies: {
                ...
                ERASE_INSIDE: eraseCircle_1.eraseInsideCircle,
            },
        ...
        this._endCallback = (evt) => {
            ...
            const enabledElement = (0, core_1.getEnabledElement)(element);
            const operationData = Object.assign(Object.assign({}, this.editData), { points: data.handles.points, viewPlaneNormal,
                viewUp, strategySpecificConfiguration: {} });
            this.editData = null;
