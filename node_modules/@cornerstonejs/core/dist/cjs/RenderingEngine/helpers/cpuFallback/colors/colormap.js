...
exports.getColormap = exports.getColormapsList = void 0;
const lookupTable_1 = __importDefault(require("./lookupTable"));
const cpuColormaps_1 = __importDefault(require("../../../../constants/cpuColormaps"));
...
function getColormapsList() {
    const colormaps = [];
    const keys = Object.keys(cpuColormaps_1.default);
    keys.forEach(function (key) {
        if (cpuColormaps_1.default.hasOwnProperty(key)) {
            const colormap = cpuColormaps_1.default[key];
            colormaps.push({
                id: key,
                name: colormap.name,
            });
...
function getColormap(id, colormapData) {
    let colormap = cpuColormaps_1.default[id];
    if (!colormap) {
        colormap = cpuColormaps_1.default[id] = colormapData || {
            name: '',
            colors: [],
        };
    }
    ...
    const cpuFallbackColormap = {
        ...
        createLookupTable() {
            const lut = new lookupTable_1.default();
