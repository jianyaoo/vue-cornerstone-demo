...
const defineProperties_1 = require("./utilities/defineProperties");
class FrameOfReferenceSpecificAnnotationManager {
    constructor(uid) {
        ...
        this.addAnnotation = (annotation, groupKey) => {
            ...
            (0, defineProperties_1.checkAndDefineTextBoxProperty)(annotation);
            (0, defineProperties_1.checkAndDefineCachedStatsProperty)(annotation);
        };
