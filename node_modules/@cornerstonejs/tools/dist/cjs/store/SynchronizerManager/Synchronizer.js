...
class Synchronizer {
    ...
    addSource(viewportInfo) {
        ...
        const viewport = (0, core_1.getRenderingEngine)(renderingEngineId).getViewport(viewportId);
        if (!viewport) {
    ...
    _updateDisableHandlers() {
        ...
        viewports.forEach(function (vUid) {
            const renderingEngine = (0, core_1.getRenderingEngine)(vUid.renderingEngineId);
            if (!renderingEngine) {
                return;
            }
