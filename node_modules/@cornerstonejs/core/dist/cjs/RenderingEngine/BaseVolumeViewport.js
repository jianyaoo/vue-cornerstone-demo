...
class BaseVolumeViewport extends Viewport_1.default {
    constructor(props) {
        ...
        this.getColormap = (applicableVolumeActorInfo) => {
            ...
            const colormapsCS3D = (0, colormap_1.getColormapNames)().map((colormapName) => (0, colormap_1.getColormap)(colormapName));
            ...
            const matchedColormap = colormaps.find((colormap) => {
                ...
                for (let i = 0; i < presetRGBPoints.length; i += 4) {
                    if (!(0, utilities_1.isEqual)(presetRGBPoints.slice(i + 1, i + 4), RGBPoints.slice(i + 1, i + 4))) {
                        return false;
                    }
                }
                return true;
    ...
    getViewReference(viewRefSpecifier = {}) {
        ...
        return Object.assign(Object.assign({}, target), { sliceIndex: this.getCurrentImageIdIndex() });
    }
    ...
    getReferenceId(specifier = {}) {
        ...
        sliceIndex !== null && sliceIndex !== void 0 ? sliceIndex : (sliceIndex = this.getCurrentImageIdIndex());
