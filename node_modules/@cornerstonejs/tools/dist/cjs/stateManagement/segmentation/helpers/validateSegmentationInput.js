...
const validateRepresentationData_1 = __importDefault(require("../../../tools/displayTools/Labelmap/validateRepresentationData"));
function validateSegmentationInput(segmentationInputArray) {
    ...
    segmentationInputArray.forEach((segmentationInput) => {
        ...
        if (segmentationInput.representation.type ===
            ...
            (0, validateRepresentationData_1.default)(segmentationInput);
        }
    });
}
exports.default = validateSegmentationInput;
