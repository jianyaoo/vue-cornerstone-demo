...
class Viewport {
    ...
    resetCamera(resetPan = true, resetZoom = true, resetToCenter = true, storeAsInitialCamera = true) {
        ...
        radius = this.type === ViewportType_1.default.VOLUME_3D ? radius * 10 : radius;
    ...
    getViewReference(viewRefSpecifier = {}) {
        ...
        const target = {
            ...
            cameraFocalPoint,
            viewPlaneNormal,
            sliceIndex: (_a = viewRefSpecifier.sliceIndex) !== null && _a !== void 0 ? _a : this.getCurrentImageIdIndex(),
        };
        return target;
    }
    isReferenceViewable(viewRef, options) {
        ...
        const camera = this.getCamera();
        if (!(0, utilities_1.isEqual)(viewPlaneNormal, camera.viewPlaneNormal) &&
            !(0, utilities_1.isEqual)(gl_matrix_1.vec3.negate(camera.viewPlaneNormal, camera.viewPlaneNormal), viewPlaneNormal)) {
            return (options === null || options === void 0 ? void 0 : options.asVolume) === true;
        }
        return true;
    }
