    ...
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this.renderAnnotation = (enabledElement, svgDrawingHelper) => {
            ...
            for (let i = 0; i < annotations.length; i++) {
                ...
                const ellipseUID = '0';
                (0, drawingSvg_1.drawEllipseByCoordinates)(svgDrawingHelper, annotationUID, ellipseUID, canvasCoordinates, {
                    color,
                    lineDash,
                    lineWidth,
                }, dataId);
        ...
        this._calculateCachedStats = (annotation, viewport, renderingEngine, enabledElement) => {
            ...
            for (let i = 0; i < targetIds.length; i++) {
                ...
                if (this._isInsideVolume(worldPos1Index, worldPos2Index, dimensions)) {
                    ...
                    const pointsInShape = (0, utilities_2.pointInShapeCallback)(imageData, (pointLPS) => (0, ellipse_1.pointInEllipse)(ellipseObj, pointLPS, { fast: true }), this.configuration.statsCalculator.statsCallback, boundsIJK);
                    const stats = this.configuration.statsCalculator.getStatistics();
                    cachedStats[targetId] = {
                        Modality: metadata.Modality,
                        area,
                        mean: (_a = stats[1]) === null || _a === void 0 ? void 0 : _a.value,
                        max: (_b = stats[0]) === null || _b === void 0 ? void 0 : _b.value,
                        stdDev: (_c = stats[2]) === null || _c === void 0 ? void 0 : _c.value,
                        statsArray: stats,
