...
const smoothPoints_1 = require("../../../utilities/planarFreehandROITool/smoothPoints");
const triggerAnnotationRenderForViewportIds_1 = __importDefault(require("../../../utilities/triggerAnnotationRenderForViewportIds"));
const updateContourPolyline_1 = __importDefault(require("../../../utilities/contours/updateContourPolyline"));
const state_1 = require("../../../stateManagement/annotation/helpers/state");
const { getSubPixelSpacingAndXYDirections, addCanvasPointsToArray, getArea } = math_1.polyline;
...
function finishEditAndStartNewEdit(evt) {
    ...
    (0, updateContourPolyline_1.default)(annotation, {
...
function completeClosedContourEdit(element) {
    ...
    if (fusedCanvasPoints) {
        const updatedPoints = (0, smoothPoints_1.shouldSmooth)(this.configuration, annotation)
            ? (0, smoothPoints_1.getInterpolatedPoints)(this.configuration, fusedCanvasPoints, prevCanvasPoints)
            : fusedCanvasPoints;
        (0, updateContourPolyline_1.default)(annotation, {
