import { d as dpdb } from './MobileVR/dpdb.json.js';
import headsets from './MobileVR/headsets.js';
...
const isWebViewAndroid = userAgent.indexOf('Version') !== -1 && userAgent.indexOf('Android') !== -1 && userAgent.indexOf('Chrome') !== -1;
const isSafari = /^((?!chrome|android).)*safari/i.test(userAgent);
const isFirefoxAndroid = userAgent.indexOf('Firefox') !== -1 && userAgent.indexOf('Android') !== -1;
const width = Math.max(window.screen.width, window.screen.height) * window.devicePixelRatio;
const height = Math.min(window.screen.width, window.screen.height) * window.devicePixelRatio;
const hardware = {
  width,
  height
};
