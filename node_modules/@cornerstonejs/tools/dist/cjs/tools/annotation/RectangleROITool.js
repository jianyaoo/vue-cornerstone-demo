        ...
        this._calculateCachedStats = (annotation, viewPlaneNormal, viewUp, renderingEngine, enabledElement) => {
            ...
            for (let i = 0; i < targetIds.length; i++) {
                ...
                if (this._isInsideVolume(worldPos1Index, worldPos2Index, dimensions)) {
                    ...
                    const pointsInShape = (0, utilities_2.pointInShapeCallback)(imageData, () => true, this.configuration.statsCalculator.statsCallback, boundsIJK);
                    const stats = this.configuration.statsCalculator.getStatistics();
                    cachedStats[targetId] = {
                        Modality: metadata.Modality,
                        area,
                        mean: (_a = stats[1]) === null || _a === void 0 ? void 0 : _a.value,
                        stdDev: (_b = stats[2]) === null || _b === void 0 ? void 0 : _b.value,
                        max: (_c = stats[0]) === null || _c === void 0 ? void 0 : _c.value,
                        statsArray: stats,
